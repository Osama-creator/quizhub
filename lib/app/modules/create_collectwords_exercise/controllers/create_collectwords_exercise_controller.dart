...
class CreateCollectwordsExerciseController extends GetxController {
  final examsService = Get.find<ExamsService>();
  final Map<String, dynamic> arguments = Get.arguments as Map<String, dynamic>;
  late String examId;
  late String teacherId;
  final List<CollectWordsQuestionC> questions = [];
  ...
  void addQuestion() {
    final questionC = CollectWordsQuestionC();
    ...
    for (int i = 0; i < questions.length; i++) {
      ...
      if (question.questionC.text.isEmpty) {
        ...
        final mcqQuestion = McqQuestion(
          ...
          rightAnswer: question.questionC.text,
